...
const ProjectDeleteModal = ({ isOpen, closeModal, confirmDelete }) => {
  ...
  return (
    <div className={`fixed top-0 left-0 z-20 h-screen w-screen bg-[#242d34bb] overflow-y-auto shadow-md`} onClick={closeModal}>
      <div className='dark:bg-gray-700 dark:text-white bg-white w-[350px] md:w-[450px] text-black absolute left-[50%] translate-x-[-50%] mt-[40px] p-4 rounded-[20px] overflow-y-auto no-scrollbar h-[200px] md:h-[250px]' onClick={(e) => e.stopPropagation()}>
        ...
        <div className='flex justify-end mt-4'>
          <button onClick={closeModal} className='dark:bg-gray-700 dark:text-white bg-gray-200 text-gray-700 px-4 py-2 rounded mr-2'>No</button>
